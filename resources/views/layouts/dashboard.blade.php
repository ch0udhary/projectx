...
<html>
  <head>
    ...
    <link rel="apple-touch-icon" href="{{ URL::asset('pages/ico/60.png')}}">
  ...
  <body class="fixed-header menu-pin menu-behind">
    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          ...
          <li class="">
            <a href="/admin/industries/create">
          ...
          <li class="">
            <a href="">
              <span class="title">Sub Industries</span>
            </a>
            <span class="icon-thumbnail"><i class="pg-layouts"></i></span>
          </li>
          <li>
                      ...
                      <div class="notification-item unread clearfix">
                        <div class="heading">
                          <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                            <img width="30" height="30" data-src-retina="{{ URL::asset('assets/img/profiles/1x.jpg')}}" data-src="{{ URL::asset('assets/img/profiles/1.jpg')}}" alt="" src="{{ URL::asset('assets/img/profiles/1.jpg')}}">
                          </div>
                          <a href="#" class="text-complete pull-left">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown pull-right d-lg-block d-none">
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
              ...
              <a href='/changepassword' class="dropdown-item"><i class="pg-signals"></i> Chnage Password</a>
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="assets/img/profiles/2x.jpg" data-src="assets/img/profiles/2.jpg" src="{{ URL::asset('assets/img/profiles/2x.jpg')}}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ URL::asset('assets/img/profiles/3x.jpg')}}" data-src="assets/img/profiles/3.jpg" src="assets/img/profiles/3x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{ URL::asset('assets/img/profiles/4x.jpg')}}" data-src="assets/img/profiles/4.jpg" src="assets/img/profiles/4x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
              ...
              <div class="chat-inner" id="my-conversation">
                ...
                <div class="message clearfix">
                  <div class="profile-img-wrapper m-t-5 inline">
                    <img class="col-top" width="30" height="30" src="{{ URL::asset('assets/img/profiles/avatar_small.jpg')}}" alt="" data-src="assets/img/profiles/avatar_small.jpg" data-src-retina="assets/img/profiles/avatar_small2x.jpg">
                  </div>
    ...
    <div class="overlay hide" data-pages="search">
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="{{ URL::asset('assets/img/logo.png')}}" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
              ...
              <div class="col-md-6">
                ...
                <div class="">
                  ...
                  <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                    <div>
                      <img width="50" height="50" src="{{ URL::asset('assets/img/profiles/avatar.jpg')}}" data-src="assets/img/profiles/avatar.jpg" data-src-retina="assets/img/profiles/avatar2x.jpg" alt="">
                    </div>
                  </div>
    ...
    <!-- BEGIN CORE TEMPLATE JS -->
    <script src="{{ URL::asset('pages/js/pages.js')}}"></script>
